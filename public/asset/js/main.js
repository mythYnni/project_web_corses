(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        var $offCanvasNav = $('.mobile-menu'),
            ...
            /*Open Off Canvas Sub Menu by Default*/
        ...
        $('.instructor__slider__active').slick({
            ...
            dots: false,
            arrows: false,
            autoplay: true, // Kích hoạt chế độ tự chạy
            autoplaySpeed: 1000, // Thiết lập tốc độ tự chạy (đơn vị milliseconds)
            responsive: [
                {
                    breakpoint: 2000,
                    settings: {
...
var swiper = new Swiper(".ecommerce__slider", {
    ...
    slidesPerView: 1,
    autoplay: {
        delay: 5000, // Đặt thời gian delay là 2000ms (2 giây)
